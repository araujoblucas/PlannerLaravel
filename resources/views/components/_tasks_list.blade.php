    ...
    <div class="mt-3">
        ...
        <form class="flex w-full" method="POST" action="{{ route('task_create')}}">
            ...
            <div class="flex w-full items-center border-b border-teal-500 py-2">
                <input required name="fast_task" class="appearance-none bg-white border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Add task..." />
                <input class="flex-shrink-0 cursor-pointer bg-teal-500 hover:bg-teal-700 border-teal-500 hover:border-teal-700 text-sm border-4 text-white py-1 px-2 rounded" value="Adicionar" type="submit" />
            </div>
        </form>
    </div>
</div>